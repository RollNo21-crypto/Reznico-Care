...
export function EmployeeLayout({ currentView, setCurrentView }) {
  return (
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-gray-950">
        ...
        <main className="flex-1 bg-gray-950">
          ...
          {/* Main content area - Employee has limited access */}
          {currentView === 'dashboard' && <EmployeeDashboard onNavigate={setCurrentView} />}
