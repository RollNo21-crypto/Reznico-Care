...
function App() {
  ...
  const userRole = user?.publicMetadata?.role || 'customer' // Default to customer instead of employee
  const [currentView, setCurrentView] = useState('landing')

  // Handle URL-based routing and set default view based on role
  useEffect(() => {
  ...
  // Customer onboarding view (handled in main layout now)
  // Removed separate customer onboarding view section
